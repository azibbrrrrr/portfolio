...
type: Robotics Coursework Project
summary: |
  Developed and optimized a deep CNN model, improved test accuracy from 67% to 84% through hyperparameter tuning, batch normalization, and data augmentation.
...
tools:
  ...
  - 'Google Colab'
  - 'Python'
colab: 'https://colab.research.google.com/drive/1XLDGUEgvQh0lKbIOnrBhm1CkhwMhN33_?usp=sharing'
---
